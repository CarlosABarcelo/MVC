(function(global, factory) {
    ...
    var CheckboxInline = function($$$1) {
        ...
        var Default = {
            bmdFormGroup: {
                create: false,
                // no bmd-form-group creation if form-group not present. It messes with the layout.php.
                required: false
            }
        };
        /**
    ...
    var BaseLayout = function($$$1) {
        var ClassName = {
            CANVAS: "bmd-layout.php-canvas",
            CONTAINER: "bmd-layout.php-container",
            BACKDROP: "bmd-layout.php-backdrop"
        };
        var Selector = {
        ...
        var BaseLayout =
            ...
            function(_Base) {
                ...
                // protected
                // Will wrap container in bmd-layout.php-canvas if necessary
                ...
                _proto.resolveCanvas = function resolveCanvas() {
                    ...
                    return bd;
                }; // Find closest bmd-layout.php-container based on the given context
                ...
                _proto.findCanvas = function findCanvas(raiseError, context) {
                    ...
                    return canvas;
                }; // Will add bmd-layout.php-backdrop to bmd-layout.php-container if necessary
    ...
    var BootstrapMaterialDesign = function($$$1) {
        ...
        var Default = {
            ...
            drawer: {
                selector: ".bmd-layout.php-drawer"
            },
            file: {
